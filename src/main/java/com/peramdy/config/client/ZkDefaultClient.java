 ...
 * @author pd
 */
public class ZkDefaultClient {

    private Logger logger = LoggerFactory.getLogger(ZkDefaultClient.class);
    ...
    public static void main(String[] args) {
        ZkDefaultClient zkClient = new ZkDefaultClient();
        ...
        zkClient.getChildrenNodeValue("/PdConfig/peramdy");
        zkClient.getNodeValue("/PdConfig/peramdy/desc");

        zkClient.deleteNode("/PdConfig/peramdy", -1);
